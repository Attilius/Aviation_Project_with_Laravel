        ...
        <b-navbar id="navbar" class="navbar" toggleable="lg">
            <div class="left_">
                ...
                <div id="menu" class="sideMenu">
                    ...
                    <div class="menu-body">
                        <div class="travel-guide-routes">
                            <router-link
                                id="router"
                                to="/travel-guide"
                                v-currentpage
                                >Travel Guide</router-link
                            >
                            <router-link
                                id="router"
                                to="/travel-guide"
                            ...
                            <router-link
                                ...
                                to="/travel-guide"
                                v-currentpage
                                >Search a destination</router-link
                            >
                            <router-link
                                id="router"
                                to="/travel-guide"
                                v-currentpage
                                >Map of destination</router-link
                            >
                        </div>
                        <div class="lorem-arlines-routes">
                            <router-link id="router" to="/" v-currentpage
                                >Lorem Airlines website</router-link
                            >
                            <router-link id="router" to="/" v-currentpage
                            ...
                            >
                            <router-link id="router" to="/contact" v-currentpage
...
.travel-guide-routes #router,
.lorem-arlines-routes #router {
    height: 40px;
    width: 100%;
    display: flex;
    align-items: center;
